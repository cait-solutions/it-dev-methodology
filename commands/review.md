...
- [Если есть 🔴 — что конкретно нужно исправить перед merge]
- [Если есть 🟡 — явный вопрос: "исправить сейчас или отложить?"]
- [Если нет проблем — "можно деплоить, подтверди: y/n"]

### ✅ Прошло проверку (не требует действий)
- [что проверено и соответствует правилам — это информация, не чеклист]
