...
- [ ] **Показ обновлённых карт пользователю** *(контроль процесса):* после `update-mermaid-links.sh` — вывести список map-артефактов которые этот /code реально обновил, с их свежими mermaid.live ссылками:
  ```
