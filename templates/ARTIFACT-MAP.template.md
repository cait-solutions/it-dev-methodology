...
| `work/<stream>/` | **Дом продуктов работы** (Artifact Storage Rule): research-отчёты, аналитика, контент, deliverables по направлениям. Плоско; структура папок = индекс. Граница: `inbox/`=вход, `docs/`=спека, `work/`=наш output | при создании продукта работы | AI Agent / Developer | Developer, PM/Owner | — | ⚡ по событию |
