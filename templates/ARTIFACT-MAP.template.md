...
> **Паттерн для больших диаграмм:** если URL > 2000 символов — упрости диаграмму (убери style-строки, они только цвет). Одна диаграмма — одна кликабельная ссылка. Разбивать на mini + full запрещено.
