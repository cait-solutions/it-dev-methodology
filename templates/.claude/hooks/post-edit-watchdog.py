...
def main():
    ...
    # SYS-001: pako-inline detection — G-100 recurrence guard.
    # pako base64 URLs must be written by update-mermaid-links.sh, never generated inline by the model.
    if "](pako:" in changed_text:
        print(
            "[post-edit-watchdog] ⛔ G-100 pako-inline detected: a pako: URL was written inline.\n"
            "  pako base64 strings must be generated by scripts/update-mermaid-links.sh only.\n"
            "  Revert this edit and run: bash scripts/update-mermaid-links.sh <file>",
            file=sys.stderr
        )
